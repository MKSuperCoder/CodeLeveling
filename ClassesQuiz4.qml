...
ApplicationWindow {
    ...
    Rectangle {
        ...
        TextEdit {
            ...
            height: 54
            color: "#f5f0f0"
            text: qsTr("Which of the following are valid access specifiers in C++?\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignHCenter
        ...
        TextEdit {
            ...
            height: 65
            color: "#f5f0f0"
            text: qsTr("a) internal, protected, public\n\n")
            font.pixelSize: 20
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("b) private, protected, public\n\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("c) private, sealed, public \n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("d) readonly, public, protected \n\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        Button {
            ...
            onClicked: {
                if (checkBox1.checked && !checkBox.checked && !checkBox2.checked && !checkBox3.checked) {
                    ...
                    logicHandler.handleNavigation("ClassesQuiz5.qml", mainWindow);
                } else {
                    errorPopup.open()
