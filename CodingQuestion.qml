...
ApplicationWindow {
    ...
    FileHandler {
        id: filehandler
        questionFilePath: ":/CodingQuestions/.qtcreator/questions1.txt"
        exampleOutputFilePath: ":/CodingQuestions/.qtcreator/exampleoutput1.txt"
    }
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: logicHandler.handleNavigation("CodingQuestion2.qml", mainWindow)
        }
