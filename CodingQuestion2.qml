...
ApplicationWindow {
    ...
    FileHandler {
        id: filehandler
        questionFilePath: ":/CodingQuestions/.qtcreator/question2.txt"
        exampleOutputFilePath: ":/CodingQuestions/.qtcreator/exampleoutput2.txt"
    }
    ...
    Rectangle {
        ...
        Button {
            ...
            onClicked: logicHandler.handleNavigation("CodingQuestion3.qml", mainWindow)
        }
