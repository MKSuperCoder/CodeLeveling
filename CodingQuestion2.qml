...
ApplicationWindow {
    ...
    Rectangle {
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("c)A portion of memory to store a value, identified by a unique name.\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("d) A keyword used to declare constants.\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        Button {
            ...
            onClicked: {
                if (checkBox.checked && !checkBox1.checked && !checkBox2.checked && !checkBox3.checked) {
                    ...
                    logicHandler.handleNavigation("CodingQuestion3.qml", mainWindow);
                } else {
