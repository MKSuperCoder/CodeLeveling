...
ApplicationWindow {
    ...
    Rectangle {
        ...
        TextEdit {
            ...
            height: 54
            color: "#f5f0f0"
            text: qsTr("Which of the following examples correctly demonstrates a range-based for loop in C++?\n")
            font.pixelSize: 15
            horizontalAlignment: Text.AlignHCenter
        ...
        TextEdit {
            ...
            height: 65
            color: "#f5f0f0"
            text: qsTr("a)  for (int i : {1, 2, 3, 4}) { std::cout << i; }\n\n")
            font.pixelSize: 15
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("b) for (int i = 0; i < 4; i++) { std::cout << i; }\n\n")
            font.pixelSize: 15
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("c) for (auto i : 1..4) { std::cout << i; }\n")
            font.pixelSize: 15
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("d) for (int i in range(1, 4)) { std::cout << i; }\n\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
