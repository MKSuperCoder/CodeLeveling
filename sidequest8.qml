...
ApplicationWindow {
    ...
    Rectangle {
        ...
        TextEdit {
            ...
            height: 54
            color: "#f5f0f0"
            text: qsTr("Which keyword is used to define a function that doesn’t modify the class instance it belongs to?\n")
            font.pixelSize: 15
            horizontalAlignment: Text.AlignHCenter
        ...
        Button {
            ...
            onClicked: {
                if (checkBox2.checked && !checkBox.checked && !checkBox1.checked && !checkBox3.checked) {
                    ...
                    logicHandler.handleNavigation("sidequest9.qml", mainWindow);
                } else {
                    errorPopup.open()
