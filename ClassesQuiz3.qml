...
ApplicationWindow {
    ...
    Rectangle {
        ...
        TextEdit {
            ...
            height: 54
            color: "#f5f0f0"
            text: qsTr("What is the purpose of access specifiers in a class?\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignHCenter
        ...
        TextEdit {
            ...
            height: 65
            color: "#f5f0f0"
            text: qsTr("a) To specify the size of the class.\n\n")
            font.pixelSize: 20
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("b) To manage the visibility of members outside the class.\n\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("c) To define the data type of the class. \n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        TextEdit {
            ...
            height: 63
            color: "#f5f0f0"
            text: qsTr("d) To create objects of the class. \n\n")
            font.pixelSize: 20
            horizontalAlignment: Text.AlignLeft
            verticalAlignment: Text.AlignTop
        }
        ...
        Button {
            ...
            onClicked: {
                if (checkBox1.checked && !checkBox.checked && !checkBox2.checked && !checkBox3.checked) {
                    ...
                    logicHandler.handleNavigation("ClassesQuiz4.qml", mainWindow);
                } else {
                    errorPopup.open()
